...
class JsonGet:
    ...
    def __init__(self, fileName=None):
        self.path = r'C:\Users\lenovo\Desktop\TSFAPython\\'
        # self.path = r'/Users/chongrongyin/boyfriend/json/'
        # self.path = r'/Users/tongjia/Desktop/credit_test/testJson/'
        # self.path = r'C:\Users\90688\Desktop\\'
        self.js = {}
        # self.js_get(fileName=None)
    ...
    UNKPHONE = json.js_count(json=jsmod_UNKPHONE, reference='未知号码', reference_json='cell_operator_zh')
    ...
    res = json.js_substr(json=jsmod, condition='latter', reference_json='evidence', reference='占比为')
    res = json.js_substr(json=jsmod, condition='latter', reference_json='evidence', reference='占比为', length=5)
    res = json.js_substr(json=jsmod, condition='latter', reference_json='evidence', length=6)
